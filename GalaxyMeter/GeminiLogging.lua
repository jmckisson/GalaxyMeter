...
--local GeminiLoggingInst = TargetTools:new()
--GeminiLoggingInst:Init()
Apollo.RegisterPackage(GeminiLogging, "GeminiLogging-1.1", 1, {"drafto_inspect-1.1", "GeminiConsole"})
